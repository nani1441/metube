...
$q = mysql_query("SELECT mid,uid,Title,MediaPath,Type,UserName FROM `Media` m natural join `userList`u where `Type` like 'video%' and permission='public' order by `UploadTime` DESC") or die(mysql_error());
