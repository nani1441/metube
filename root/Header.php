    ...
    <body onload="initiate()">
		<div id="main-wrapper">	
			<div id="center">
				<div id="logo">
				<p><a href="Search.php">
<img src="images/Logos/Metube3.png" alt="logo" width="300" height="100" />
</a>
</p>
				</div>
			</div>		
...
<div id="side-bar">
    <ul>
			...
			echo "</li>";
			echo "<li>";
			echo "<a id=\"favorite\" href=\"Favourites.php\">Favorited Media</a>";
			echo "</li>";
			echo "<li>";
			echo "<a id=\"playlists\" href=\"ViewPlaylist.php\">Playlists</a>";
			echo "</li>";
			echo "<li>";
			echo "<a id=\"history\" href=\"UserHistory.php\">Your History</a>";
			echo "</li>";
			...
			echo "</li>";
			echo "<li>";
			echo "<a id=\"disscussions\" href=\"ViewFDisscussions.php\">Group Disscussions</a>";
			echo "</li>";
			$q = mysql_query("SELECT COUNT(*) FROM `FriendList` where uid_friend='$uid' and status='0'") or die(mysql_error());
			$row = mysql_fetch_assoc($q);
			$requests = $row['COUNT(*)'];
			echo "<li>";
			echo "<a id=\"friends\" href=\"FriendList.php\" target=\"_self\">Friends(".$requests.")</a>";
			echo "</li>";
			echo "<li>";
			echo "<a id=\"uChannels\" href=\"ListSubscribes.php\" target=\"_self\"> Your Channels </a>";
			echo "</li>";
			echo "<li>";
